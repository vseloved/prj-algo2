//
// Created by Artem on 07.10.16.
//

#ifndef PROJECTOR_COMMONSUBSEQUENCE_H
#define PROJECTOR_COMMONSUBSEQUENCE_H
...
public:
	CommonSubsequence(string word1, string word2) {
...
#endif //PROJECTOR_COMMONSUBSEQUENCE_H
